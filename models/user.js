...
const userSchema = new Schema({
  ...
  cart: {
    items: [
      //this is how we identify array of obj
      {
        productId: {
...
//we can add methods to our schema so we saparate concerns

userSchema.methods.addToCart = function (product) {
  //it has to be function no arrow func because we want to use this
  ...
  //check if prod in the cart increase quantity
